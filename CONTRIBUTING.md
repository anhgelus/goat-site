...
The maintainers of GoAT Site do not use LLMs.
...
**Remember that GoAT Site is made for humans and by humans.**
...
The package `site` (root) follows strictly the Standard.site.
Other packages contain extensions of the standard.
...
go work use path/to/goat-site # override the GoAT Site in the go.mod by the one present in this folder
```
